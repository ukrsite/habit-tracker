...
- Name: ui.spec.ts >> can navigate to GitHub OAuth
- Location: e2e/ui.spec.ts:22:1
...
Expected pattern: /github\.com/
Received string:  "http://localhost:3000/api/auth/github"
Timeout: 5000ms

Call log:
  - Expect "toHaveURL" with timeout 5000ms
    14 × unexpected value "http://localhost:3000/api/auth/github"

```

```yaml
- text: "{\"error\":\"GitHub OAuth not configured\"}"
```
